function mpc = test_system_10_gen_beta_u_sigma_001_data
...
% included are the optimal beta values if optimising with uncertainty with
% a sigma value of 0.01
Beta_Mean = [8.02, 14.34, 12.02, 8.23, 7.24, 8.86, 9.19, 8.63, 8.07, 6.81];
