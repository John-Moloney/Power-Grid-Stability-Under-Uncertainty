function mpc = test_system_10_gen_distribution_uncertainty
...
%% Beta Values
% Homogeneous
% Beta_Mean = [7.7509, 7.7509, 7.7509, 7.7509, 7.7509, 7.7509, 7.7509, 7.7509, 7.7509, 7.7509];
%Heterogeneous
% Beta_Mean = [16.1463, 12.1373, 14.8274, 13.4470, 11.9233, 6.9060, 8.8805, 11.6709, 11.9206, 5.9096];
% Optimisation under uncertainty
 Beta_Mean = [8.7505, 9.0755, 7.5101, 6.6618, 7.8693, 7.4350, 7.4355, 8.3185, 7.1952, 6.7755];
